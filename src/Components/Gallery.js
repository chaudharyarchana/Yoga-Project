    ...
    <div className="container w-full mx-auto mb-20 bg-gray-200  ">
      <div className="container flex flex-wrap w-full mx-auto  h-28 sm:h-40">
        <Image
          src="/images/img1.jpg"
          alt="image"
          className="w-1/3 sm:w-1/6 h-full object-cover "
          width={250}
          height={100}
        />
        <Image
          ...
          width={250}
          height={100}
          className="w-1/3 sm:w-1/6 h-full object-cover  transition duration-300 ease-in-out filter grayscale hover:filter-none hover:grayscale-0"
        />
        <Image
          src="/images/img3.jpg"
          alt="image"
